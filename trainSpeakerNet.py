...
parser.add_argument('--train_lists_save_path', type=str, default="train_lists_save_path",
                    help="Saved train lists' path");
parser.add_argument('--eval_lists_save_path', type=str, default="eval_lists_save_path", help="Saved test lists' path");
...
parser.add_argument('--miss_modality', type=str, default="none",
                    help='A data stream to miss at evaluation model only, e.g. audio: "wav", visual: "rgb", thermal: "thr"');
...
def main(args):
    ...
    if "gender" in args.test_list:
        ...
        args.eval_lists_save_path = os.path.join(args.eval_lists_save_path, "not_gender")
